...
这不是通用实时翻译工具，而是专门给 Steam PC 版《Fallout Shelter》做的本地补丁生成器。通用工具适合快速试用很多游戏；这个项目更关注这款游戏本身的字体、文本和界面显示，目标是做得更稳定。
...
这不是通用实时翻译工具。它只针对《Fallout Shelter》做本地补丁，重点处理字体、文本和界面显示，尽量减少漏翻、错位、译文长度和文本框不匹配。
